...
//  Shared
//
//  Created by Andrea Paraggio on 23/12/21.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            if preProcessImage == nil && contouredImage == nil {
                Image("paiolato")
                .resizable()
                .scaledToFit()
            }
    ...
    func detectVisionContours() {
        ...
        if let sourceImage = UIImage.init(named: "paiolato") {
            ...
            contourRequest.contrastPivot = 1.0
            
            contourRequest.maximumImageDimension = 512
            
            do {
                    let noiseReductionFilter = CIFilter.gaussianBlur()
                    noiseReductionFilter.radius = 1.0
            ...
            self.contouredImage = drawContours(
                contoursObservation: contoursObservation,
                sourceImage: sourceImage.cgImage!
            )
    ...
    override public var outputImage: CIImage! {
        get {
            if let inputImage = self.inputImage {
                ...
                return createCustomKernel().apply(
